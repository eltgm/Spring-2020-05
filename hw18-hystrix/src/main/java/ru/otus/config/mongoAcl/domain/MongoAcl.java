 ...
 */
package ru.otus.config.mongoAcl.domain;
...
public class MongoAcl {
     ...
     */
    public MongoAcl(String instanceId, String className, String id) {
        this.id = id;
     ...
     *                          entries
     */
    public MongoAcl(String instanceId, String className, String id, MongoSid owner,
                    String parentId, boolean entriesInheriting) {
        this.id = id;
        this.instanceId = instanceId;
        this.className = className;
