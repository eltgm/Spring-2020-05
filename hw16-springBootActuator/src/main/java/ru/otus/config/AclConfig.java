...
import ru.otus.config.mongoAcl.mongodb.BasicLookupStrategy;
import ru.otus.config.mongoAcl.mongodb.MongoDBMutableAclService;
...
public class AclConfig {
    ...
    public PermissionGrantingStrategy permissionGrantingStrategy() {
        final var consoleAuditLogger = new ConsoleAuditLogger();
